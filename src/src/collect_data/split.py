...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default= "en.clips", required=True,
                        help='full path to data. i.e. /to/path/clips/')
    parser.add_argument('--file_name', type=str, default= "en.file", required=True,
                        help='common voice file')
    parser.add_argument('--save_path', type=str, default= "en.wav", required=True,
