...
if __name__ == "__main__":
    ...
    parser.add_argument('--wakewords_dir', type=str, default='./SAVE_FILE' ,
                        help='directory of clips with wakewords')

    parser.add_argument('--copy_destination', type=str, default='./Duplicate/', 
                        help='directory of the destinations of the wakewords copies')

    parser.add_argument('--copy_number', type=int, default=10, required=False,
